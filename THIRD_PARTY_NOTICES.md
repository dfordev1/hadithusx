...
The whole-corpus working index and imported pilot witnesses are derived from the Open Islamicate Texts Initiative (OpenITI) corpus.

- Project: https://openiti.org/
- Source repositories and exact commits: `sources/source-lock.json`
- Individual source-file SHA-256 checksums: `sources/source-lock.json`
- License: Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International (CC BY-NC-SA 4.0)
- License text: https://creativecommons.org/licenses/by-nc-sa/4.0/
- OpenITI licensing documentation: https://openiti.org/documentation/
